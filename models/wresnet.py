...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        self.fc2 = nn.Linear(nChannels[2], num_classes)
        self.fc1 = nn.Linear(nChannels[1], num_classes)
        self.nChannels = nChannels[3]
        self.nChannels2 = nChannels[2]
        self.nChannels1 = nChannels[1]
    ...
    def forward(self, x):
        ...
        out = self.block2(out)
        out = self.block3(out)
        out = self.relu(self.bn(out)) #原来是bn
