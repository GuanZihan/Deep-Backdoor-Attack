...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000, block_name='BasicBlock'):
        ...
        self.layer1, self.downsample_layer_1 = self._make_layer(block, 16, n)
        self.layer2, self.downsample_layer_2 = self._make_layer(block, 32, n, stride=2)
        
        self.layer3, self.downsample_layer_3 = self._make_layer(block, 64, n, stride=2)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        return nn.Sequential(*layers), layers[0]
