...
def get_arguments():
    ...
    parser.add_argument('--unlearning_root', type=str, default='./weight/ABL_unlearning_results',
    ...
    parser.add_argument('--finetuning_epochs', type=int, default=50, help='number of finetuning epochs to run')
    parser.add_argument('--unlearning_epochs', type=int, default=25, help='number of unlearning epochs to run')
